...
const treeTrunkMaterial = new MeshLambertMaterial({
  color: treeTrunkColor
});
const treeCrownMaterial = new MeshLambertMaterial({
...
function Truck() {
  ...
  const cargo = new Mesh(
    ...
    new MeshLambertMaterial({ color: 0xffffff }) // 0xb4c6fc
  );
  cargo.position.x = -15;
  cargo.position.z = 30;
  ...
  const cabin = new Mesh(new BoxGeometry(25, 30, 30), [
    ...
    new MeshLambertMaterial({ color }), // back
    new MeshLambertMaterial({ color, map: truckLeftTexture }),
    new MeshLambertMaterial({ color, map: truckRightTexture }),
    new MeshLambertMaterial({ color }), // top
    new MeshLambertMaterial({ color }) // bottom
  ]);
  cabin.position.x = 40;
  cabin.position.z = 20;
  cabin.castShadow = true;
